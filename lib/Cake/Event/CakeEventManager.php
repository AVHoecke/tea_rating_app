 ...
 *
 * @param EventManager $manager Optional event manager instance.
 ...
 * when the event named with $eventKey is triggered. If a EventListener instance is passed, then the `implementedEvents`
 ...
 *
 * @param EventListener $subscriber Event listener.
 * @return void
 */
