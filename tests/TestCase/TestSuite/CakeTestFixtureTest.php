 ...
 */
namespace Test\TestCase\TestSuite;
 ...
 * @package       Cake.Test.Case.TestSuite
 */
class CakeTestFixtureTestFixture extends TestFixture {
 ...
 * @package       Cake.Test.Case.TestSuite
 */
class InvalidTestFixture extends TestFixture {
 ...
 */
	public function testInitDbPrefix() {
		...
		$Fixture->create(ConnectionManager::get('fixture_test_suite'));
		...
		$Fixture->drop(ConnectionManager::get('fixture_test_suite'));
		$Source->drop($db);
	}
 ...
 */
	public function testInitDbPrefixDuplication() {
		...
		$newDb = ConnectionManager::get('fixture_test_suite');
 ...
 */
	public function testImport() {
		$testSuiteDb = ConnectionManager::get('test');
		...
		$newTestSuiteDb = ConnectionManager::get('new_test_suite');
