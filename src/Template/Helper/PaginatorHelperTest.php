 ...
 */
	public function testUrlMultiplePagination() {
		...
		$result = $this->Paginator->generateUrl(array());
		...
		$this->assertTags($result, $expected);
		$result = $this->Paginator->generateUrl(array('sort' => 'name'));
 ...
 */
	public function testQuerystringUrlGeneration() {
		...
		$result = $this->Paginator->generateUrl(array('page' => '1'));
		$expected = '/';
		$this->assertEquals($expected, $result);

		$result = $this->Paginator->generateUrl(array('page' => '1', 'limit' => 10, 'something' => 'else'));
		$expected = '/index/something:else?limit=10';
		$this->assertEquals($expected, $result);

		$result = $this->Paginator->generateUrl(array('page' => '4'));
		$expected = '/?page=4';
		$this->assertEquals($expected, $result);

		$result = $this->Paginator->generateUrl(array('page' => '4', 'limit' => 10, 'something' => 'else'));
 ...
 */
	public function testOptionsConvertKeys() {
		...
		$result = $this->Paginator->generateUrl(array('page' => '4', 'something' => 'bar'));
