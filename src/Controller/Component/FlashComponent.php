 ...
 * Constructor
 *
 * @param ComponentRegistry $collection The ComponentRegistry object
 ...
 */
	...
	public function set($message, $options = array()) {
		...
		if ($options['clear'] === false) {
			$messages = (array)Session::read('Message.' . $options['key']);
		}
		...
		Session::write('Message.' . $options['key'], $messages);
	}
