 ...
 * @package       Cake.Test.Case.Network
 */
class TestCakeRequest extends Request {
 ...
 * CakeRequestTest
 */
class CakeRequestTest extends TestCase {
 ...
 */
	public function testclientIp() {
		...
		$this->assertEquals('192.168.1.3', $request->clientIp(), '		$this->assertEquals('192.168.1.3', $request->clientIp(false), '	}
 ...
 */
	public function testParamWriting() {
		...
		$this->assertInstanceOf('Request', $request->param('some', 'thing'), 'Method has not returned $this');
