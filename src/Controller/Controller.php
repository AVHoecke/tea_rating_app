 ...
 * @property      string $action  The action handling the current request. Deprecated, use Request::$action instead.
 * @property      string $base    Base URL path. Deprecated, use Request::$base instead.
 * @property      array $data     POST data. Deprecated, use Request::$data instead.
 * @property      string $here    The full address to the current request. Deprecated, use Request::$here instead.
 * @property      array $paginate Pagination settings.
 * @property      array $params   Array of parameters parsed from the URL. Deprecated, use Request::$params instead.
 * @property      string $webroot Webroot path segment for the request.
 * @link          https://book.cakephp.org/2.0/en/controllers.html
 */
class Controller extends CakeObject implements EventListener {
...
/**
 * Instance of ComponentRegistry used to handle callbacks.
 *
 ...
 * Constructor.
 *
 * @param Request $request Request object for this controller. Can be null for testing,
 *  but expect that features that use the request parameters will not work.
 * @param Response $response Response object for this controller.
 */
 ...
 * @deprecated 3.0.0 Since 2.4. Will be removed in 3.0. Use Response::httpCodes().
 */
...
/**
 * Convenience and object wrapper method for Response::header().
 *
 * @param string $status The header message that is being set.
 * @return void
 * @deprecated 3.0.0 Will be removed in 3.0. Use Response::header().
 */
 ...
 * @deprecated 3.0.0 Will be removed in 3.0. Use Response::disableCache().
 */
