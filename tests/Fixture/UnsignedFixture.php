 ...
 * @package       Cake.Test.Fixture
 */
class UnsignedFixture extends TestFixture {
 ...
 */
	public $fields = array(
		'uinteger' => ['type' => 'integer', 'null' => '', 'default' => '1', 'length' => '8', 'unsigned' => true],
		...
		'_constraints' => ['primary' => ['type' => 'primary', 'columns' => ['uinteger']]],
		'_options' => ['engine' => 'MyISAM']
	);
