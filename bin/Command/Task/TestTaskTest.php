...
use App\Controller\ComponentRegistry", $result);
use App\Controller\Component\ExampleComponent", $result);
use App\Controller\TestTaskCommentsController", $result);
use App\Model\Behavior\ExampleBehavior", $result);
use App\Model\Model;
use App\Model\TestTaskArticle", $result);
use App\View\Helper\ExampleHelper", $result);
use Cake\Console\ConsoleInput;
use Cake\Console\ConsoleOutput;
use Cake\Console\Shell;
use Cake\Console\ShellDispatcher;
use Cake\Controller\Component", $result);
 ...
 */
	public function testBakeModelTest() {
		...
		$this->assertContains("		$this->assertContains('class TestTaskArticleTest extends TestCase', $result);
 ...
 */
	public function testBakeControllerTest() {
		...
		$this->assertContains("		$this->assertContains('class TestTaskCommentsControllerTest extends ControllerTestCase', $result);
 ...
 */
	public function testBakeComponentTest() {
		...
		$this->assertContains("		$this->assertContains("		$this->assertContains("		$this->assertContains('class ExampleComponentTest extends TestCase', $result);
 ...
 */
	public function testBakeBehaviorTest() {
		...
		$this->assertContains("		$this->assertContains('class ExampleBehaviorTest extends TestCase', $result);
 ...
 */
	public function testBakeHelperTest() {
		...
		$this->assertContains("		$this->assertContains('class ExampleHelperTest extends TestCase', $result);
 ...
 */
	public function testGenerateUses() {
		...
		$expected = array(
			array('ComponentRegistry', 'Controller'),
