 ...
 * TestHttpSocket
 */
class TestHttpSocket extends Client {
...
/**
 * Test that Client::__construct does what one would expect it to do
 *
 * @return void
 */
...
/**
 * Test that Client::configUri works properly with different types of arguments
 *
 * @return void
 */
...
/**
 * Tests that Client::request (the heart of the HttpSocket) is working properly.
 *
 * @return void
 */
...
/**
 * Asserts that Client::parseUri is working properly
 *
 * @return void
 */
...
/**
 * Tests that Client::buildUri can turn all kinds of uri arrays (and strings) into fully or partially qualified URI's
 *
 * @return void
 */
...
/**
 * Asserts that Client::parseQuery is working properly
 *
 * @return void
 */
...
/**
 * Tests that Client::buildHeader can turn a given $header array into a proper header string according to
 * HTTP 1.1 specs.
 *
 * @return void
 */
...
/**
 * Tests that Client::_tokenEscapeChars() returns the right characters.
 *
 * @return void
 */
...
/**
 * Test that Client::escapeToken is escaping all characters as described in RFC 2616 (HTTP 1.1 specs)
 *
 * @return void
 */
...
/**
 * This tests asserts Client::reset() resets a HttpSocket instance to it's initial state (before CakeObject::__construct
 * got executed)
 *
 * @return void
 */
...
/**
 * This tests asserts Client::reset(false) resets certain HttpSocket properties to their initial state (before
