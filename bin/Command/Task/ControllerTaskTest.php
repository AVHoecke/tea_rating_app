...
use ControllerTest\Controller\ControllerTestAppController;", $result);
 ...
 */
	public function testBakeWithPlugin() {
		...
		$this->assertContains("		$this->assertEquals('ControllerTest', $this->Task->Template->templateVars['plugin']);
