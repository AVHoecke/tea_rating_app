 ...
 */
	public function testFlash() {
		...
		$Controller = new Controller($request, $this->getMock('Response', array('_sendHeader')));
		...
		$Controller = new Controller($request);
		$Controller->response = $this->getMock('Response', array('_sendHeader'));
 ...
 */
	public function testComponentBeforeRenderChangingViewClass() {
		...
		$Controller = new Controller($this->getMock('Request'), new Response());
 ...
 */
	public function testToBeInheritedGuardmethods() {
		...
		$Controller = new Controller($request, $this->getMock('Response'));
 ...
 */
	public function testRedirectByCode($code, $msg) {
		...
		$Controller->response = $this->getMock('Response', array('header', 'statusCode'));

		$Controller->Components = $this->getMock('ComponentRegistry', array('trigger'));
 ...
 */
	public function testRedirectBeforeRedirectModifyingParamsArrayReturn() {
		...
		$Controller->response = $this->getMock('Response');
		$Controller->Components = $this->getMock('ComponentRegistry', array('trigger'));
 ...
 */
	public function testRedirectBeforeRedirectInController() {
		...
		$Controller->response = $this->getMock('Response', array('header'));
		$Controller->Components = $this->getMock('ComponentRegistry', array('trigger'));
 ...
 */
	public function testRefererSlash() {
		$request = $this->getMock('Request', array('referer'));
		$request->base = '/base';
 ...
 */
	public function testControllerHttpCodes() {
		$response = $this->getMock('Response', array('httpCodes'));
 ...
 */
	public function testStartupProcess() {
		...
		$eventManager = $this->getMock('EventManager');
 ...
 */
	public function testStartupProcessIndirect() {
		...
		$Controller->Components->expects($this->exactly(2))->method('trigger')->with($this->isInstanceOf('Event'));
 ...
 */
	public function testShutdownProcessIndirect() {
		...
		$Controller->Components->expects($this->exactly(1))->method('trigger')->with($this->isInstanceOf('Event'));
