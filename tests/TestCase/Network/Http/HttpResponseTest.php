...
/**
 * Test that Client::parseHeader can take apart a given (and valid) $header string and turn it into an array.
 *
 * @return void
 */
...
/**
 * Test that escaped token strings are properly unescaped by Client::unescapeToken
 *
 * @return void
 */
