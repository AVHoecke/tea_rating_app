 ...
 */
	public function testUsingCustomRouteClass() {
		$this->getMock('Route', array(), array(), 'MockConnectedRoute', false);
...
/**
 * test that route classes must extend Route
 *
 ...
 */
	...
	public function testReverseToArrayCakeRequestQuery() {
		$request = new Request('/posts/view/123');
		$request->addParams(array(
			'controller' => 'posts',
			'action' => 'view',
			'pass' => array(123),
 ...
 */
	public function testUrlFullUrlReturnFromRoute() {
		...
		$this->getMock('Route', array(), array('/'), 'MockReturnRoute');
 ...
 */
	public function testRouteRedirection() {
		...
		Router::$routes[0]->response = $this->getMock('Response', array('_sendHeader'));
 ...
 */
	public function testDefaultRouteClass() {
		$this->getMock('Route', array(), array('/test'), 'TestDefaultRouteClass');
