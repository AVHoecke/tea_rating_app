 ...
 */
	public function main() {
		if (empty($this->params['xml'])) {
			...
			$this->out(__d('cake_console', "Your working path should be the same as your application path. To change your path			$this->out(__d('cake_console', "Example: {0} or {1}", '-app relative/path/to/myapp', '-app /absolute/path/to/myapp'), 2);
