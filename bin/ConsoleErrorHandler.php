 ...
 */
	public function handleException($exception) {
		...
		$stderr->write(__d('cake_console', "<error>Error:</error> {0}\n{1}",
 ...
 */
	public function handleError($code, $description, $file = null, $line = null, $context = null) {
		...
		$message = __d('cake_console', '{0} in [{1}, line {2}]', $description, $file, $line);
		$stderr->write(__d('cake_console', "<error>{0} Error:</error> {1}\n", $name, $message));
